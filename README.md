...
* MoveXYZW: The Robot moves to the specific waypoint, which is represented by the XYZW End-Effector coordinates.
  ```sh
  ros2 action send_goal -f /MoveXYZW ros2_data/action/MoveXYZW "{goalx: 0.00, goaly: 0.00, goalz: 0.00, goalw: 0.00}"
  ```
