...
# cr35ia.launch.py:
# Launch file for the Fanuc CR35-iA Robot GAZEBO + MoveIt!2 SIMULATION in ROS2 Humble:
...
def generate_launch_description():
    ...
    moveJ_interface = Node(
        ...
        output="screen",
        parameters=[robot_description, robot_description_semantic, kinematics_yaml, {"use_sim_time": True}, {"ROB_PARAM": 'cr35ia_arm'}],
    )
    # MoveG ACTION:
