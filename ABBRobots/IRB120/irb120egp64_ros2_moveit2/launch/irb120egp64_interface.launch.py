...
# irb120egp64_interface.launch.py:
# Launch file for the ABB-IRB120 Robot + SCHUNK-EGP64 Gripper GAZEBO + MoveIt!2 SIMULATION (+ Robot/Gripper triggers) in ROS2 Foxy:
...
def generate_launch_description():
    ...
    irb120_ros2_gazebo = os.path.join(
        get_package_share_directory('irb120egp64_ros2_gazebo'),
        'worlds',
        'irb120egp64.world')
    ...
    # ***** ROBOT DESCRIPTION ***** #
    # ABB-IRB120 + SCHUNK-EGP64 Description file package:
    irb120egp64_description_path = os.path.join(
        get_package_share_directory('irb120egp64_ros2_gazebo'))
    # ABB-IRB120 + SCHUNK-EGP64 ROBOT urdf file path:
    xacro_file = os.path.join(irb120egp64_description_path,
                              'urdf',
                              'irb120egp64.urdf.xacro')
    # Generate ROBOT_DESCRIPTION for ABB-IRB120 + SCHUNK-64:
    ...
    robot_description_semantic_config = load_file(
        "irb120egp64_ros2_moveit2", "config/irb120egp64.srdf"
    )
    ...
    kinematics_yaml = load_yaml(
        "irb120egp64_ros2_moveit2", "config/kinematics.yaml"
    )
    ...
    ompl_planning_yaml = load_yaml(
        "irb120egp64_ros2_moveit2", "config/ompl_planning.yaml"
    )
    ompl_planning_pipeline_config["move_group"].update(ompl_planning_yaml)

    # MoveIt!2 Controllers:
    moveit_simple_controllers_yaml = load_yaml(
        "irb120egp64_ros2_moveit2", "config/irb120egp64_controllers.yaml"
    )
    moveit_controllers = {
    ...
    rviz_base = os.path.join(get_package_share_directory("irb120egp64_ros2_moveit2"), "launch")
