...
// MoveG ACTION SERVER for SCHUNK EGP-64 Gripper.
...
private:
    ...
    void execute(const std::shared_ptr<GoalHandle> goal_handle)
    {
        ...
        if(success) {
            ...
            RCLCPP_INFO(this->get_logger(), "Schunk EGP-64 - MoveG: Planning successful!");
            ...
            if (goal_handle->is_canceling()) {
                ...
                RCLCPP_INFO(this->get_logger(), "Schunk EGP-64 - MoveG: Movement executed!");
                result->result = "MoveG:SUCCESS";
                goal_handle->succeed(result);
            }

        } else {
            RCLCPP_INFO(this->get_logger(), "Schunk EGP-64 - MoveG: Planning failed!");
