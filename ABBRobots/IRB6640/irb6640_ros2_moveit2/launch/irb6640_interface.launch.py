...
# irb6640.launch.py:
# Launch file for the ABB-IRB6640 Robot GAZEBO + MoveIt!2 SIMULATION in ROS2 Foxy:
...
def generate_launch_description():
    ...
    ompl_planning_yaml = load_yaml("irb6640_ros2_moveit2", "config/ompl_planning.yaml")
    ompl_planning_pipeline_config["move_group"].update(ompl_planning_yaml)

    # MoveIt!2 Controllers:
    moveit_simple_controllers_yaml = load_yaml("irb6640_ros2_moveit2", "config/irb6640_controllers.yaml")
    moveit_controllers = {
    ...
    rviz_base = os.path.join(get_package_share_directory("irb6640_ros2_moveit2"), "config")
    ...
    moveJ_interface = Node(
        ...
        output="screen",
        parameters=[robot_description, robot_description_semantic, kinematics_yaml, {"ROB_PARAM": 'irb6640_arm'}],
    )
    # MoveG ACTION:
