...
# irb1200.launch.py:
# Launch file for the ABB-IRB1200 Robot GAZEBO + MoveIt!2 SIMULATION in ROS2 Humble:
...
def generate_launch_description():
    ...
    print("Launch file -> irb1200_interface.launch.py")
    ...
    joint_trajectory_controller_spawner = Node(
        package="controller_manager",
        executable="spawner",
        arguments=["irb1200_controller", "-c", "/controller_manager"],
    )
    ...
    moveJ_interface = Node(
        ...
        output="screen",
        parameters=[robot_description, robot_description_semantic, kinematics_yaml, {"use_sim_time": True}, {"ROB_PARAM": 'irb1200_arm'}],
    )
    # MoveG ACTION:
