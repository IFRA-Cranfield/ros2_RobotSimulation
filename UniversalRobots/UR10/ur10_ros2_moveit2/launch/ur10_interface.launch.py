...
# ur10.launch.py:
# Launch file for the UR10 ROBOT GAZEBO + MoveIt!2 SIMULATION in ROS2 Humble:
...
def generate_launch_description():
    ...
    joint_trajectory_controller_spawner = Node(
        package="controller_manager",
        executable="spawner",
        arguments=["ur10_controller", "-c", "/controller_manager"],
    )
    ...
    robot_description_semantic_config = load_file("ur10_ros2_moveit2", "config/ur10.srdf")
    robot_description_semantic = {"robot_description_semantic": robot_description_semantic_config }
    
    # Kinematics.yaml file:
    kinematics_yaml = load_yaml("ur10_ros2_moveit2", "config/kinematics.yaml")
    ...
    ompl_planning_yaml = load_yaml("ur10_ros2_moveit2", "config/ompl_planning.yaml")
    ompl_planning_pipeline_config["move_group"].update(ompl_planning_yaml)

    # MoveIt!2 Controllers:
    moveit_simple_controllers_yaml = load_yaml("ur10_ros2_moveit2", "config/ur10_controllers.yaml")
    moveit_controllers = {
    ...
    rviz_base = os.path.join(get_package_share_directory("ur10_ros2_moveit2"), "config")
    ...
    moveJ_interface = Node(
        ...
        output="screen",
        parameters=[robot_description, robot_description_semantic, kinematics_yaml, {"use_sim_time": True}, {"ROB_PARAM": 'ur10_arm'}],
    )
    # MoveG ACTION:
    ...
    #     output="screen",
    #     parameters=[robot_description, robot_description_semantic, kinematics_yaml, {"use_sim_time": True}, {"ROB_PARAM": 'ur10_gripper'}],
    # )
    # MoveXYZW ACTION:
