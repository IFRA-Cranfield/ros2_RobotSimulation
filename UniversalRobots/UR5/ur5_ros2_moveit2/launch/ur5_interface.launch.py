...
# ur5.launch.py:
# Launch file for the UR5 Robot GAZEBO + MoveIt!2 SIMULATION (+ Robot/Gripper triggers) in ROS2 Foxy:
...
def generate_launch_description():
    ...
    moveJ_interface = Node(
        ...
        output="screen",
        parameters=[robot_description, robot_description_semantic, kinematics_yaml, {"ROB_PARAM": 'ur5_robot'}],
    )
    # MoveXYZW ACTION:
