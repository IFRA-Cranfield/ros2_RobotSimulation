...
// MoveJ ACTION SERVER for UR5 Robot.
    ...
    void execute(const std::shared_ptr<GoalHandle> goal_handle)
    {
        ...
        if (LimitCheck == false){
            ...
            if(success) {
                ...
                RCLCPP_INFO(this->get_logger(), "UR5 Robot - MoveJ: Planning successful!");
                ...
                if (goal_handle->is_canceling()) {
                    ...
                    RCLCPP_INFO(this->get_logger(), "UR5 Robot - MoveJ: Movement executed!");
                    result->result = "MoveJ:SUCCESS";
                    goal_handle->succeed(result);
                }

            } else {
                RCLCPP_INFO(this->get_logger(), "UR5 Robot - MoveJ: Planning failed!");
            ...
            RCLCPP_INFO(this->get_logger(), "UR5 Robot - MoveJ: Planning failed, JOINT LIMITS exceeded!");
            result->result = "MoveJ:FAILED";
            goal_handle->succeed(result);
