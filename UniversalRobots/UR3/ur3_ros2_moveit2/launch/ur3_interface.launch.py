...
# ur3.launch.py:
# Launch file for the UR3 ROBOT GAZEBO + MoveIt!2 SIMULATION in ROS2 Foxy:
...
def generate_launch_description():
    ...
    gazebo = IncludeLaunchDescription(
                ...
                launch_arguments={'world': ur3_ros2_gazebo}.items(),
             )
    ...
    print("ros2_RobotSimulation --> UR3 ROBOT")
    print("Launch file -> ur3_interface.launch.py")
    ...
    error = True
    while (error == True):
        print("     + Option N1: UR3 ROBOT alone.")
        print("     + Option N2: UR3 ROBOT on top of a pedestal.")
    ...
    # ***** ROBOT DESCRIPTION ***** #
    # UR3 ROBOT Description file package:
    ...
    xacro_file = os.path.join(ur3_description_path,
                              'urdf',
                              'ur3.urdf.xacro')
    # Generate ROBOT_DESCRIPTION for UR3 ROBOT:
    ...
    robot_description_semantic_config = load_file("ur3_ros2_moveit2", "config/ur3.srdf")
    robot_description_semantic = {"robot_description_semantic": robot_description_semantic_config }
    
    # Kinematics.yaml file:
    kinematics_yaml = load_yaml("ur3_ros2_moveit2", "config/kinematics.yaml")
    ...
    ompl_planning_yaml = load_yaml("ur3_ros2_moveit2", "config/ompl_planning.yaml")
    ompl_planning_pipeline_config["move_group"].update(ompl_planning_yaml)

    # MoveIt!2 Controllers:
    moveit_simple_controllers_yaml = load_yaml("ur3_ros2_moveit2", "config/ur3_controllers.yaml")
    moveit_controllers = {
    ...
    rviz_base = os.path.join(get_package_share_directory("ur3_ros2_moveit2"), "config")
    ...
    moveJ_interface = Node(
        ...
        output="screen",
        parameters=[robot_description, robot_description_semantic, kinematics_yaml, {"ROB_PARAM": 'ur3_arm'}],
    )
    # MoveG ACTION:
    ...
    #     output="screen",
    #     parameters=[robot_description, robot_description_semantic, kinematics_yaml, {"ROB_PARAM": 'ur3_gripper'}],
    # )
    # MoveXYZW ACTION:
