...
# ur3.launch.py:
# Launch file for the UR3 Robot GAZEBO + MoveIt!2 SIMULATION (+ Robot/Gripper triggers) in ROS2 Foxy:
...
def generate_launch_description():
    ...
    gazebo = IncludeLaunchDescription(
                ...
                launch_arguments={'world': ur3_gazebo}.items(),
             )
    ...
    robot_description_semantic_config = load_file(
        "ur3_ros2_moveit2", "config/ur3.srdf"
    )
    ...
    kinematics_yaml = load_yaml(
        "ur3_ros2_moveit2", "config/kinematics.yaml"
    )
    ...
    ompl_planning_yaml = load_yaml(
        "ur3_ros2_moveit2", "config/ompl_planning.yaml"
    )
    ompl_planning_pipeline_config["move_group"].update(ompl_planning_yaml)

    # MoveIt!2 Controllers:
    moveit_simple_controllers_yaml = load_yaml(
        "ur3_ros2_moveit2", "config/ur3_controllers.yaml"
    )
    moveit_controllers = {
    ...
    rviz_base = os.path.join(get_package_share_directory("ur3_ros2_moveit2"), "launch")
    rviz_full_config = os.path.join(rviz_base, "ur3_moveit2.rviz")
    rviz_empty_config = os.path.join(rviz_base, "ur3_moveit2_empty.rviz")
    ...
    moveJ_interface = Node(
        ...
        output="screen",
        parameters=[robot_description, robot_description_semantic, kinematics_yaml, {"ROB_PARAM": 'ur3_robot'}],
    )
    # MoveXYZW ACTION:
