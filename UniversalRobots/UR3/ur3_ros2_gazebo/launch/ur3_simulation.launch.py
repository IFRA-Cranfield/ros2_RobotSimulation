...
#  Reference: This UR3 Gazebo Simulation package has been created thanks to the information provided in the following GitHub repositories:
...
def generate_launch_description():
    ...
    print("Launch file -> ur3_simulation.launch.py")
    ...
    ur3_description_path = os.path.join(
        get_package_share_directory('ur3_ros2_gazebo'))
    # UR3 ROBOT ROBOT urdf file path:
